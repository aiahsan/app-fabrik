          ...
          <div className="d-md-flex align-items-center justify-content-between">
            ...
            <div className="d-flex align-items-center justify-content-center justify-content-md-end">
              ...
              <button className="site-btn px-4 py-2 mt-3 ml-3">
                <i className="fas fa-plus" /> New Homework
              </button>
            </div>
          </div>
          <div className="row">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="media align-items-center">
                          <img src="images/homework.png" alt="" className="img-fluid mr-2" />
                          <div className="media-body">
                            <p className="p-lg mb-0 semi-bold">Frog Surgery Project</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p className="p-lg mb-0 semi-bold blue-text">Biology</p>
                      </td>
                      <td>
                        <p className="site-btn d-inline-block mb-0 px-4 py-2">SIL</p>
                      </td>
                      <td>
                        <p className="mb-0 grey-text">14/7/2021</p>
                      </td>
                      <td>
